...
![AI 模型选择界面](/personal-blog/personal-blog-0/stage0-model-select.png)
...
![AI 初始化项目和目录结构](/personal-blog/personal-blog-0/stage0-init.png)
...
![AI 初始化完成后的目录结构](/personal-blog/personal-blog-0/stage0-git.png)
...
![在 IDE 中打开终端，从这里执行命令](/personal-blog/personal-blog-0/stage0-whereshell.png)

### 你的目录还没初始化 Git

刚拿到 AI 生成的代码时，VS Code 会提示你这个目录还没有初始化 Git：

![VS Code 提示当前目录未初始化 Git](/personal-blog/personal-blog-0/stage0-vscode-nogit.png)
...
![CNB 进入我的仓库](/personal-blog/personal-blog-0/stage0-cnb-repos.png)

![点击创建仓库](/personal-blog/personal-blog-0/stage0-cnb-create.png)

填写仓库名称（比如 `myblog`），推荐选择**私有仓库**，然后点击创建：

![创建仓库，建议选私有](/personal-blog/personal-blog-0/stage0-cnb-newrepo.png)

**第二步：获取初始化命令**

仓库创建好后，CNB 会给你一段"空仓初始化"的命令：

![CNB 创建好后的初始化提示](/personal-blog/personal-blog-0/stage0-cnb-init.png)
...
![创建访问令牌](/personal-blog/personal-blog-0/stage0-cnb-token.png)

![令牌创建成功，立刻复制保存](/personal-blog/personal-blog-0/stage0-cnb-tokendone.png)
...
![CNB 远程仓库创建完成](/personal-blog/personal-blog-0/stage0-cnb-done.png)
...
![项目文件变更列表](/personal-blog/personal-blog-0/stage0-structure.png)
